...
<link rel="stylesheet" href="public/css/toast.css?v=<?php echo asset_version('public/css/toast.css'); ?>">
...
<script src="public/js/toast.js?v=<?php echo asset_version('public/js/toast.js'); ?>"></script>
