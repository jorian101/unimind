...
INSERT INTO `Usuarios` (`nombre`, `apellido`, `email`, `cargo`, `fecha_nacimiento`, `genero`) VALUES
('Andrea', 'Vargas', 'andrea.vargas@email.com', 'Estudiante', '2004-03-10', 'Femenino'),
('Javier', 'Ramos', 'javier.ramos@email.com', 'Docente', '1985-07-22', 'Masculino'),
('Marta', 'Herrera', 'marta.herrera@email.com', 'Psicólogo', '1979-01-15', 'Femenino'),
('Pedro', 'Guzmán', 'pedro.guzman@email.com', 'Administrativo', '1990-11-28', 'Masculino'),
('Laura', 'Díaz', 'laura.diaz@email.com', 'Estudiante', '2003-05-01', 'Femenino'),
('Ricardo', 'Flores', 'ricardo.flores@email.com', 'Docente', '1970-12-05', 'Masculino'),
('Elena', 'Soto', 'elena.soto@email.com', 'Estudiante', '2006-09-19', 'Femenino'),
('Miguel', 'López', 'miguel.lopez@email.com', 'Psicólogo', '1982-04-14', 'Masculino'),
('Fernanda', 'Castro', 'fernanda.castro@email.com', 'Estudiante', '2002-02-28', 'Femenino'),
('Daniel', 'Ruiz', 'daniel.ruiz@email.com', 'Docente', '1965-08-30', 'Masculino'),
('Carla', 'Mendoza', 'carla.mendoza@email.com', 'Estudiante', '2005-10-12', 'Femenino'),
('Jorge', 'Paredes', 'jorge.paredes@email.com', 'Administrativo', '1998-06-03', 'Masculino'),
('Silvia', 'Quispe', 'silvia.quispe@email.com', 'Psicólogo', '1977-03-07', 'Femenino'),
('Roberto', 'Torres', 'roberto.torres@email.com', 'Estudiante', '2007-01-25', 'Masculino'),
('Valeria', 'Núñez', 'valeria.nunez@email.com', 'Docente', '1989-11-11', 'Femenino'),
('Alejandro', 'Vela', 'alejandro.vela@email.com', 'Estudiante', '2004-04-04', 'Masculino'),
('Cecilia', 'Baca', 'cecilia.baca@email.com', 'Administrativo', '1993-02-09', 'Femenino'),
('Felipe', 'Cáceres', 'felipe.caceres@email.com', 'Psicólogo', '1980-10-21', 'Masculino'),
('Gabriela', 'Linares', 'gabriela.linares@email.com', 'Estudiante', '2006-12-31', 'Femenino'),
('Héctor', 'Salas', 'hector.salas@email.com', 'Docente', '1972-01-01', 'Masculino'),
('Irene', 'Zapata', 'irene.zapata@email.com', 'Estudiante', '2003-08-17', 'Femenino'),
('Juan', 'Alonso', 'juan.alonso@email.com', 'Administrativo', '1995-05-18', 'Masculino'),
('Kelly', 'Bravo', 'kelly.bravo@email.com', 'Psicólogo', '1974-09-02', 'Femenino'),
('Omar', 'Molina', 'omar.molina@email.com', 'Estudiante', '2005-06-20', 'Masculino'),
('Patricia', 'Ríos', 'patricia.rios@email.com', 'Docente', '1987-04-26', 'Femenino'),
('Quentin', 'Luna', 'quentin.luna@email.com', 'Estudiante', '2002-11-03', 'Masculino'),
('Rosa', 'Vega', 'rosa.vega@email.com', 'Administrativo', '1991-07-13', 'Femenino'),
('Samuel', 'Yáñez', 'samuel.yanez@email.com', 'Psicólogo', '1976-03-29', 'Masculino'),
('Teresa', 'Zúñiga', 'teresa.zuniga@email.com', 'Estudiante', '2004-01-08', 'Femenino'),
('Víctor', 'Acuña', 'victor.acuna@email.com', 'Docente', '1968-05-16', 'Masculino');
